...
code is available at [GitHub](https://github.com/ml-research/alphailp.git).
...
Download the V-LoL-Trains dataset from [here](https://sites.google.com/view/v-lol)
and link the extracted folder in the docker command, e.g. `-v $(pwd)/V-LoL-dataset:/NSFR/data/michalski/all`. 
```
