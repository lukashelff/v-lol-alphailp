...
def get_mode_declarations_michalski(lang, obj_num):
    ...
    modeb_list = [
        ...
        ModeDeclaration('body', 4, lang.get_pred_by_name('car_num'), [p_car, s_int]),
        ModeDeclaration('body', 4, lang.get_pred_by_name('color'), [p_car, s_color]),
        ModeDeclaration('body', 4, lang.get_pred_by_name('length'), [p_car, s_length]),
        ModeDeclaration('body', 4, lang.get_pred_by_name('wall'), [p_car, s_wall]),
        ModeDeclaration('body', 4, lang.get_pred_by_name('roof'), [p_car, s_roof]),
        ModeDeclaration('body', 4, lang.get_pred_by_name('closed'), [p_car]),
        ModeDeclaration('body', 3, lang.get_pred_by_name('behind'), [p_car, p_car]),
        ModeDeclaration('body', 4, lang.get_pred_by_name('load_num'), [p_car, s_int]),
        ModeDeclaration('body', 4, lang.get_pred_by_name('smaller'), [s_int, s_int]),
        ModeDeclaration('body', 2, lang.get_pred_by_name('different_color'), [s_color, s_color]),
        # ModeDeclaration('body', 1, lang.get_pred_by_name('equal'), [p_car]),
        ModeDeclaration('body', 4, lang.get_pred_by_name('wheel'), [p_car, s_int]),
        ModeDeclaration('body', 4, lang.get_pred_by_name('load1'), [p_car, s_load1]),
        ModeDeclaration('body', 4, lang.get_pred_by_name('load2'), [p_car, s_load2]),
        ModeDeclaration('body', 4, lang.get_pred_by_name('load3'), [p_car, s_load3]),
    ]
    return modeb_list
